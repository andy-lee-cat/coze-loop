...
type Client interface {
	...
	AddNumbers(ctx context.Context, req *expt.AddNumbersRequest, callOptions ...callopt.Option) (r *expt.AddNumbersResponse, err error)
}
...
func (p *kExperimentServiceClient) AddNumbers(ctx context.Context, req *expt.AddNumbersRequest, callOptions ...callopt.Option) (r *expt.AddNumbersResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
